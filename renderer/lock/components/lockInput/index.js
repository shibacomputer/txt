    ...
    <section class=${style.lock}>
      <div class=${style.unlocker}>
        ...
        <div class="${style.inputfield} ${state.error? style.headShake : ''}">
          <input placeholder=${state.error? opts.error : opts.placeholder} autocomplete="current-password" type="password" class="${style.input} ${style.ready} ${state.error? style.error : ''}"/>
